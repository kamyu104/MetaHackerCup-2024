...
|D| [Sushi Platter](https://www.facebook.com/codingcompetitions/hacker-cup/2024/final-round/problems/D)| [Python3](./Final%20Round/sushi_platter.py3)  | _O(N^3 * MAX_A + M! * ((M - 1) * 2^(M - 1)))_ | _O(N^2 * MAX_A)_ | Medium | | Connected Component DP, Prefix Sum, Bitmasks |
