...
|B| [Least Common Ancestor](https://www.facebook.com/codingcompetitions/hacker-cup/2024/round-3/problems/B)| [Python3](./Round%203/least_common_ancestor.py3) | _O(N * logN * logM)_ | _O(N)_ | Easy | | Sort, DFS, Sorted List, Freq Table, Small-to-Large Merging |
